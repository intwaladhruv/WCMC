...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_STUDENT = "_student0";
    ...
    public String getData()
    {
        ...
        String[] column = new String[] {KEY_ID, KEY_NAME, KEY_EMAIL, KEY_MOBILE};
    ...
    public String getName (long l1)
    {
        db = this.getReadableDatabase();
        String[] column = new String[] {KEY_ID, KEY_NAME, KEY_EMAIL, KEY_MOBILE};
        Cursor cursor = db.query(TABLE_STUDENT, column, KEY_ID+"="+l1, null, null, null, null);
        if(cursor!=null)
        {
            cursor.moveToFirst();
